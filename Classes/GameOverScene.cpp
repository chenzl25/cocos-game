...
bool GameOverScene::init()
{
	...
	auto currentMoney = Label::createWithTTF(tempMoney->getCString(), "fonts/Marker Felt.ttf", visibleSize.height * SCORE_FONT_SIZE);
	...
	auto highMoneyLabel = Label::createWithTTF(tempHighMoney->getCString(), "fonts/Marker Felt.ttf", visibleSize.height * SCORE_FONT_SIZE);
